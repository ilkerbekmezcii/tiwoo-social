...
public final class IletService extends Service {
    ...
    @Override public void onCreate(){
        ...
        if(Build.VERSION.SDK_INT>=29)startForeground(FOREGROUND_ID,n,ServiceInfo.FOREGROUND_SERVICE_TYPE_CONNECTED_DEVICE);
        else startForeground(FOREGROUND_ID,n);
        IletRuntime.get(this).start();
    }
    @Override public int onStartCommand(Intent i,int flags,int id){IletRuntime.get(this).start(); return START_STICKY;}
