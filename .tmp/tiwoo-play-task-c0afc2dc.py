...
def fail(msg):
    print(json.dumps({"ok":False,"error":msg},ensure_ascii=False));sys.exit(1)
def dec():
    k2s=os.environ.get("TIWOO_K2","")
...
def main():
    ...
    print(json.dumps({"ok":True,"packageName":PKG,"internal":rel,"listingUpdated":True,"images":{"icon":1,"featureGraphic":1,"phoneScreenshots":4},"committed":True},ensure_ascii=False))
